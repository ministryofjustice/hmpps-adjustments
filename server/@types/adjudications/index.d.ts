...
export interface paths {
  ...
  '/reported-adjudications/migrate': {
    /** migrates a record into the adjudication service */
  ...
  '/reported-adjudications/migrate/reset': {
    /** resets the migration and removes all migrated records from database */
...
export interface components {
  schemas: {
    ...
    PunishmentDto: {
       ...
       * @enum {string}
       */
      privilegeType?: 'CANTEEN' | 'FACILITIES' | 'MONEY' | 'TV' | 'ASSOCIATION' | 'OTHER'
    ...
    PunishmentRequest: {
      ...
      consecutiveReportNumber?: string
      /**
       * Format: double
    ...
    AdjudicationMigrateDto: {
      ...
      statement: string
      reportingOfficer: components['schemas']['ReportingOfficer']
      /** @description created by username from nomis audit - to be mapped to reviewedBy */
      createdByUsername: string
      prisoner: components['schemas']['MigratePrisoner']
      offence: components['schemas']['MigrateOffence']
      /** @description witnesses */
      witnesses: components['schemas']['MigrateWitness'][]
      /** @description damages / repairs */
      damages: components['schemas']['MigrateDamage'][]
      /** @description evidence */
      evidence: components['schemas']['MigrateEvidence'][]
      /** @description punishments / sanctions */
      punishments: components['schemas']['MigratePunishment'][]
      /** @description hearings */
      hearings: components['schemas']['MigrateHearing'][]
      /** @description dis issued */
      disIssued: components['schemas']['DisIssued'][]
    }
    /** @description dis issued */
    DisIssued: {
      issuingOfficer: string
    ...
    MigrateEvidence: {
       ...
       * @enum {string}
       */
      evidenceCode: 'PHOTO' | 'BODY_WORN_CAMERA' | 'CCTV' | 'BAGGED_AND_TAGGED' | 'OTHER'
    ...
    MigrateHearing: {
      ...
      commentText?: string
      hearingResult?: components['schemas']['MigrateHearingResult']
    ...
    MigrateWitness: {
       ...
       * @enum {string}
       */
      witnessType: 'OFFICER' | 'STAFF' | 'OTHER_PERSON' | 'VICTIM' | 'PRISONER'
      /**
       * Format: date
       * @description date added
       */
    ...
    MigrateResponse: {
      chargeNumberMapping: components['schemas']['ChargeNumberMapping']
      /** @description hearing mappings */
      hearingMappings?: components['schemas']['HearingMapping'][]
      /** @description punishment mappings */
      punishmentMappings?: components['schemas']['PunishmentMapping'][]
    }
...
export interface operations {
  ...
  migrate: {
    ...
    requestBody: {
      content: {
        'application/json': components['schemas']['AdjudicationMigrateDto']
      }
    }
    responses: {
      ...
      201: {
        content: {
          '*/*': components['schemas']['MigrateResponse']
        }
      }
      /** @description Unauthorized */
      401: {
