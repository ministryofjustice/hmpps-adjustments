...
import TimeSpentInCustodyAbroadOffencesForm from './timeSpentInCustodyAbroadOffencesForm'

export default class TimeSpentInCustodyAbroadSelectOffencesModel {
  ...
  constructor(
    ...
    public form: TimeSpentInCustodyAbroadOffencesForm,
  ...
  public backlink(): string {
    return `/${this.prisonerNumber}/custody-abroad/days/${this.addOrEdit}/${this.id}`
  }
